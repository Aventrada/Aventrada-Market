...
interface AventradaLogoDarkProps extends SVGProps<SVGSVGElement> {
  color?: string
}

export function AventradaLogoDark({ color = "#818CF8", width = 32, height = 32, ...props }: AventradaLogoDarkProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 512 512" fill="none" {...props}>
      <path
        ...
        fill={color}
      />
      <circle cx="232" cy="232" r="56" fill={color} />
    </svg>
  )
}
