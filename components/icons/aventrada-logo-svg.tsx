...
interface AventradaLogoSVGProps extends SVGProps<SVGSVGElement> {
  color?: string
}

export function AventradaLogoSVG({ color = "#6366F1", width = 32, height = 32, ...props }: AventradaLogoSVGProps) {
  return (
